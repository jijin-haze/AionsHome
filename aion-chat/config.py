...
MODELS = {
    ...
    "[满血A] Gemini-3.1-Pro-Thinking": {"provider": "aipro","model": "gemini-3.1-pro-preview-thinking-512"},
    "[特价B] Claude-Sonnet-4.5": {"provider": "aipro","model": "claude-sonnet-4-5-20250929"},
    "[特价B] Claude-Sonnet-4.6": {"provider": "aipro","model": "claude-sonnet-4-6"},
    "[特价C] Claude-Opus-4.6-Thinking": {"provider": "aipro","model": "claude-opus-4-6-thinking-c"}
